...
from src.gaze_estimation.models.layers import Conv, Hourglass, Pool, Residual
from src.gaze_estimation.models.losses import HeatmapLoss
from src.gaze_estimation.util.softargmax import softargmax2d
